      ...
      <PopoverContent align="end">
        <div className="flex flex-col gap-5">
          <div className="space-y-1.5">
            <h4 className="font-medium text-sm leading-none">Referensi</h4>
            <p className="text-muted-foreground text-xs">Kustomisasi Dashboard Layout</p>
            <p className="font-medium text-muted-foreground text-xs">
              *Preferences menggunakan cookies secara default. Anda dapat beralih antara cookies, localStorage, atau tidak ada penyimpanan dalam kode.
            </p>
          </div>
